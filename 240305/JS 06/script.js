...
const progresCover = document.querySelector(".progress");

const videoPoint = () => {
  const mouseX = e.pageX - player.offsetLeft;
  const width = progresCover.clientWidth;
...
rateButtons.forEach(() => {
  playButton.addEventListener("click", setRate);
});

progresCover.addEventListener("click", videoPoint);
