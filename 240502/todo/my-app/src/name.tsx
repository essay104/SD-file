...
// // 7) 함수 타입호환성 > 매개변수 기준 (매개변수의 개수가 같은 경우!!)
...
// //제네릭 타입 정의
// // Generic => genenral (*종합적인)
// // 제네릭 타입을 사용하는 이유 : 현재 시점에서는 어떤 타입의 변수 및 state가 들어올 지 모르는 상태일때 우선 타입을 정의해야하는 경우

// // 반론제기!! => 어떤값이 들어올지 미정, 타입 cheat key : any
