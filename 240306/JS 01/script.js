...
// 1) JS객체 => 일반객체 > 배열객체
// 2) 일반객체
// 장점 : key, value값을 가지고 있는 프로퍼티
// 데이터 체계적으로 보관, 관리, 사용
// 단점 : for...in => 객체 안에 있는 value값 만을 찾아와서 직접적으로 반복문을 돌릴 수 있는 방법 x
// 단점 2 : 객체 안에 구성되어 있는 아이템들은 배열처럼 인덱스 번호를 할당받지 못한다!!!

// 3) 배열객체
// 장점 : 배열안에 포함되어있는 아이템들이 고유의 인덱스 값을 가지고 있으며, for문을 활용한 반복문으로 업무의 효율성을 극대화할 수 있다.
